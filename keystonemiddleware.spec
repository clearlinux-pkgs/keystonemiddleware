...
Version  : 2.4.0
Release  : 21
URL      : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-2.4.0.tar.gz
Source0  : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-2.4.0.tar.gz
...
%prep
%setup -q -n keystonemiddleware-2.4.0

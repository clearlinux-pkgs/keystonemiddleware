...
Version  : 1.5.2
Release  : 15
URL      : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-1.5.2.tar.gz
Source0  : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-1.5.2.tar.gz
...
%prep
%setup -q -n keystonemiddleware-1.5.2

...
Version  : 4.0.0
Release  : 24
URL      : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-4.0.0.tar.gz
Source0  : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-4.0.0.tar.gz
...
%prep
%setup -q -n keystonemiddleware-4.0.0

...
Version  : 2.4.1
Release  : 22
URL      : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-2.4.1.tar.gz
Source0  : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-2.4.1.tar.gz
...
%prep
%setup -q -n keystonemiddleware-2.4.1

...
Version  : 4.8.0
Release  : 34
URL      : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-4.8.0.tar.gz
Source0  : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-4.8.0.tar.gz
...
%prep
%setup -q -n keystonemiddleware-4.8.0

...
Version  : 2.3.1
Release  : 20
URL      : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-2.3.1.tar.gz
Source0  : http://tarballs.openstack.org/keystonemiddleware/keystonemiddleware-2.3.1.tar.gz
...
%prep
%setup -q -n keystonemiddleware-2.3.1
